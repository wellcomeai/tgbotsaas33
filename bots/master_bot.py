...
class MasterBot:
    ...
    def _setup_handlers(self):
        """✅ ОБНОВЛЕНО: Setup handlers with admin functionality, media support and file_id command"""
        # Basic commands
...
"""
    ...
    async def start_polling(self):
        ...
        logger.info("✅ Master bot started with trial system, access control, media broadcast functionality, and file_id command")
