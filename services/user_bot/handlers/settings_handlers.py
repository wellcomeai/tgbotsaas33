...
- <code>&lt;u&gt;подчеркнутый&lt;/u&gt;</code>  • <code>&lt;a href="url"&gt;ссылка&lt;/a&gt;</code>
...
<b>Описание:</b>
Reply кнопка отображается вместе с приветственным сообщением. 
После нажатия пользователем кнопка исчезает и отправляется сообщение подтверждения.
Также запускается воронка продаж (если настроена).
...
<b>Описание:</b>
Это сообщение отправляется пользователю после нажатия на кнопку приветствия.
...
<b>Примеры:</b>
- "Спасибо, {{first_name}}! Добро пожаловать в наш канал!"
- "Отлично! Теперь вы полноправный участник сообщества."
...
<b>Описание:</b>
Inline кнопка с ссылкой отправляется вместе с прощальным сообщением для удержания пользователей.

<b>Примеры текста кнопки:</b>
- "🔔 Вернуться в канал"
