...
class ContentAgentService:
    ...
    def format_rewrite_response(
        ...
        """✅ РАСШИРЕННОЕ форматирование ответа рерайта с дополнительной информацией"""
        ...
        try:
            ...
            formatted_result = {
                ...
                'media': media_info,  # Для обратной совместимости
                'has_media': has_media,
            ...
            logger.debug("✅ Enhanced rewrite response formatted successfully with links", 
            ...
            logger.error("💥 Error formatting enhanced rewrite response with links", 
                        error=str(e),
