...
class Settings(BaseSettings):
    ...
    robokassa_payment_amount: float = Field(default=5.0, env="ROBOKASSA_PAYMENT_AMOUNT")  # 5 рублей
    robokassa_is_test: bool = Field(default=False, env="ROBOKASSA_IS_TEST")  # ПРОДАКШЕН
    # Token purchase settings
    robokassa_tokens_amount: float = Field(default=5.0, env="ROBOKASSA_TOKENS_AMOUNT")  # 5 рублей
